        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <ul>
                        <li><a href="<?php echo HTTP_ROOT . 'pages/privacy-policy' ?>">PRIVACY POLICY</a></li>
                        <li><a href="<?php echo HTTP_ROOT . 'pages/content' ?>">CONTENT</a></li>
                        <li><a href="<?php echo HTTP_ROOT . 'pages/contact_us' ?>">CONTACT US</a></li>
                        <li><a href="<?php echo HTTP_ROOT . 'pages/web-master' ?>">WEBMASTERS</a></li>
    ...
    <div id="boxes">
        <div id="san">
            ...
            <div class="css-only-modal">
                <p><?=$paymentwidget->change_text;?></p>
                <a href="http://maturegapers.com/joinus"><img src="<?=HTTP_ROOT;?>images/card.png" alt=""></a>
            </div>
        </div>
    </div>
...
<style>
    ...
    #boxes{
        ...
        border: 2px solid <?=$paymentwidget->border_color;?>;
    }
    #dialog,#san{
        height : <?=$paymentwidget->height;?>px;
        width : <?=$paymentwidget->width;?>px;
