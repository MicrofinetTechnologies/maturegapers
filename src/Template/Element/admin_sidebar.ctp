...
<!--                    <li class="<?php if ($paramController == 'Appadmins' && $paramAction == 'modelBanner') { ?> active <?php } ?>"><a href="<?= h(HTTP_ROOT) ?>appadmins/model_banner"><i class="fa  fa-female"></i> Model Banner</a></li>-->
            ...
            <li class="treeview <?php if ($paramController == 'Appadmins' && (($paramAction == 'scenes') || ($paramAction == 'scenesList') || ($paramAction == 'scenesphotoGallery') || ($paramAction == 'managemscenesPhotos') || ($paramAction == 'managemscenesPhotos') || ($paramAction == 'scenetrailerVideo') || ($paramAction == 'scenemainVideo') || ($paramAction == 'getFiles') || ($paramAction == 'scenebonusVideo') || ($paramAction == 'basicSceneSetting') || ($paramAction == 'updatefolder') || ($paramAction == 'updateftpvideo') || ($paramAction=='deleteSourceFile'))) { ?> active <?php } ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($paramController == 'Appadmins' && ($paramAction == 'getFiles' || $paramAction == 'updatefolder' || $paramAction == 'updateftpvideo')) { ?> active <?php } ?>">
                <a href="<?php echo HTTP_ROOT ?>appadmins/getFiles" >
                    <i class="fa fa-file-video-o"></i> <span>Received Video File Form FTP</span>
                </a>
            </li>
                    <li class="<?php if ($paramController == 'Appadmins' && ($paramAction == 'deleteSourceFile') ) { ?> active <?php } ?>"><a href="<?= h(HTTP_ROOT) ?>appadmins/delete_source_file"><i class="fa  fa-bullseye"></i> Delete Source File</a></li>
...
<!--            <li class="treeview <?php if ($paramController == 'Appadmins' && $paramAction == 'paymentGateways') { ?> active <?php } ?>">
            ...
            <li class="treeview <?php if ($paramController == 'Appadmins' && ($paramAction == 'manageMembers')) { ?> active <?php } ?>">
                <a href="<?= h(HTTP_ROOT) ?>appadmins/manage_members" ><i class="fa fa-fw fa-money"></i> <span> Manage Members</span></a>
                
            </li>

            <li class="treeview <?php if ($paramController == 'Appadmins' && ($paramAction =='createMembership' || $paramAction == 'waterMarkSetting'||$paramAction == 'profile' || $paramAction == 'generalSetting' || $paramAction == 'viewAdmin' || $paramAction == 'footerCms' || $paramAction == 'socialMedia' || $paramAction == 'websiteIcon' ||  $paramAction == 'homeCms' || $paramAction == 'modelHairColor' || $paramAction == 'modelEyeColor' || $paramAction=='sceneSetting')) { ?> active <?php } ?>">
                ...
                <ul class="treeview-menu">
                   <li class="<?php if ($paramController == 'Appadmins' && $paramAction == 'generalSetting') { ?> active <?php } ?>"><a href="<?= h(HTTP_ROOT) ?>appadmins/generalSetting"><i class="fa fa-gear"></i>General Setting</a></li>
                    ...
                    <li class="<?php if ($paramController == 'Appadmins' && $paramAction == 'sceneSetting') { ?> active <?php } ?>"><a href="<?php echo HTTP_ROOT ?>appadmins/scene_setting" ><i class="fa fa-newspaper-o"></i> <span>Home page 1st scenes Setting</span></a></li>
                    ...
                    <li class="<?php if ($paramController == 'Appadmins' && $paramAction == 'createMembership') { ?> active <?php } ?>"><a href="<?= h(HTTP_ROOT) ?>appadmins/create_membership"><i class="fa fa-money"></i>Membership</a></li>
