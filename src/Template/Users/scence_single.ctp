        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="single-scence-banner">
                    ...
                    <video class="thevideo2" controls crossorigin playsinline preload="none"  id="player">
                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/720p_' . $scenevideo->video_file)) { ?>
                            <source src="<?php echo VIDEOS . $scenesdetails->id . '/720p_' . $scenevideo->video_file; ?>" type="video/mp4" size="720">
                        <?php } ?>

                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/360p_' . $scenevideo->video_file)) { ?>
                            <source src="<?php echo VIDEOS . $scenesdetails->id . '/360p_' . $scenevideo->video_file; ?>" type="video/mp4" size="360">
                        <?php } ?>

                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/1080p_' . $scenevideo->video_file)) { ?>
                            <source src="<?php echo VIDEOS . $scenesdetails->id . '/1080p_' . $scenevideo->video_file; ?>" type="video/mp4" size="1080">
                        <?php } ?>

                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/4K_' . $scenevideo->video_file)) { ?>
                            <source src="<?php echo VIDEOS . $scenesdetails->id . '/4K_' . $scenevideo->video_file; ?>" type="video/mp4" size="2160">
                        <?php } ?>

                        <?php if (!file_exists(VIDEOS . $scenesdetails->id . '/4K_' . $scenevideo->video_file) && !file_exists(VIDEOS . $scenesdetails->id . '/1080p_' . $scenevideo->video_file) && !file_exists(VIDEOS . $scenesdetails->id . '/360p_' . $scenevideo->video_file) && !file_exists(VIDEOS . $scenesdetails->id . '/720p_' . $scenevideo->video_file)) { ?>
                            <source src="<?php echo VIDEOS . $scenesdetails->id . '/' . $scenevideo->video_file; ?>" type="video/mp4" size="480">
                        <?php } ?>


                        <a href="<?= VIDEOS . $scenesdetails->id . '/' . $scenevideo->video_file; ?>" type="video/mp4" download>Download</a>
                    </video>
                    <ul class="data-video" style="position: relative;">
                        <!--        <a href="../../View/Helper/UserHelper.php"></a>-->
                        <li>
                            <?php if ($video_download->download_video == 1) { ?>
                                <div style="position: absolute;top: -24px;left: 0;">
                                    ...
                                    <span>
                                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/360p_' . $main_video_duration->video_file)) { ?>
                                            <!--<a href="<?php echo HTTP_ROOT . 'users/videodownload/' . $main_video_duration->id . '/360p_'; ?>" target="_blank">360p</a>                                    -->
                                            <a href="<?php echo HTTP_ROOT . 'joinus'; ?>" target="_blank">360p</a>                                    
                                        <?php } ?>
                                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/720p_' . $main_video_duration->video_file)) { ?>
                                            , <a href="<?php echo HTTP_ROOT  . 'joinus'; ?>" target="_blank">720p</a>                                    
                                        <?php } ?>
                                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/1080p_' . $main_video_duration->video_file)) { ?>
                                            , <a href="<?php echo HTTP_ROOT  . 'joinus'; ?>" target="_blank">1080p</a>                                    
                                        <?php } ?>
                                        <?php if (file_exists(VIDEOS . $scenesdetails->id . '/4K_' . $main_video_duration->video_file)) { ?>
                                            , <a href="<?php echo HTTP_ROOT  . 'joinus' ?>" target="_blank">4K</a>                                    
<!--                                            , <a href="<?php //echo HTTP_ROOT . 'users/videodownload/' . $scenevideo->id . '/4K_'; ?>" target="_blank">4K</a>                                    -->
                                        <?php } ?>
                                    </span> 
                                </div>
                            <?php } ?>
...
<!--                        <li><a href="#"><i class="fas fa-download"></i> Download</a></li>-->
                         <li class="bonus-button"><?php if(!empty($this->User->chkBonusVideo($scenesdetails->id))){ ?>
                             <a class="btn btn-danger"  href="<?php echo HTTP_ROOT . 'joinus';?>" style="color: #fff;background: red;font-weight: bold;font-size: 17px;padding: 6px 20px 7px;">Bonus videos</a>
                                 <?php } ?>
                         </li> 
                        <li>Length: <span><?= $main_video_duration->video_durations; ?></span></li>
                                ...
                                <main id="gallery">
                                    <div class="header-top">
                                        <?php foreach ($scenegallery as $gallery) {
                                            ...
                                            <a href="<?php
                                            if ($gallery->type == 1) {
                                                echo HTTP_ROOT . 'scene-photos/' . $scenesdetails->id . '/' . $gallery->name;
                                            } else {
                                                echo HTTP_ROOT . 'joinus';
                                            }
                                            ?>">
                                                ...
                                                <div class="col-sm-3 col-lg-3 col-md-3">
                                                    <ul>
                                                        ...
                                                        foreach ($modelphotos1 as $photo) {
                                                            ...
                                                            if ($cxt <= 4) {
                                                                ?>
                                                                <li  style="transform: rotate(<?= $deg -= 12; ?>deg);max-height:120px;"><img src="<?= HTTP_ROOT . PHOTOS . 'scenes/' . $scenesdetails->id . '/' . $gallery->name . '/' . $photo->files_name; ?>"></li>
                                                            <?php
                                                            }
                                                        }
                                                        ?>
                                            ...
                                            <div class="img-slide-im">
                                                <div class="item2">
                                                    ...
                                                    foreach ($img_scen as $value) {
                                                        $ewww++;
                                                        if ($ewww == 1) {
                                                            $first = HTTP_ROOT . PHOTOS . $value->photo_name;
                                                        }
                                                        ?>

                                                        <img src="<?= HTTP_ROOT . PHOTOS . $value->photo_name; ?>" alt="">
                                                    <?php }
                                                    ?>
                                                </div>
                                            </div>
