...
.header-main .right-top ul li:nth-child(2) a {
    background: <?=$skincolor->bg_color;?> url(../images/lock.png) 15px center no-repeat;
}
.header-main .right-top ul li:nth-child(3) a:hover {
    background: <?=$skincolor->background_hover_color;?> url(../images/join.png) 15px center no-repeat;
}
