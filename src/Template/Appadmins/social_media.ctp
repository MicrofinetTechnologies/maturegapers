           ...
           <div class="col-md-12">
            <div class="col-md-6">
             <div class="form-group">
              ...
              ?>
              <?= $this->Form->input('name', ['class' => "form-control", 'label' => false, 'data-error' => 'Please enter social name', 'required' => "required", 'maxlength' => 200, 'value' => @$dataEdit->name]); ?>
             ...
             <div class="form-group">
                 ...
                 <?= $this->Form->input('image', ['type' => 'text', 'id' => 'image', 'class' => "form-control", 'label' => false, 'kl_virtual_keyboard_secure_input' => "on", 'required' => "required", 'value'=>@$dataEdit->image, 'data-error' => 'Please Enter icon code']); ?>
                 <div class="help-block with-errors"></div>
             </div>
            </div>
            <div class="col-md-6">
       ...
       <tbody id="list">
        <?php foreach ($dataListings as $list): ?>
           <tr id="arrayorder_<?php echo $list->id; ?>" class="message_box ui-sortable-handle">
            ...
            <td style="text-align:  left;"><?php echo htmlspecialchars($list->image)?></td>
