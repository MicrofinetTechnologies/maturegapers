                    ...
                    <div class="box-body">
                        ...
                        <div class="col-xs-12" style="margin-bottom: 40px;">
                            <div class="form-group" style=" position: relative;">
                                ...
                                <?php 
                                if (!empty(@$editData->miniature_pic)) { ?>
                                    <img src="<?php echo HTTP_ROOT . PHOTOS . @$editData->miniature_pic; ?>" alt="" width="100">
                                    <a href="<?=HTTP_ROOT;?>appadmins/deleteminiature_pic/<?=@$editData->id;?>"><i class="fa fa-trash" style="position: absolute;left: 113px;padding: 10px;background: #0003;font-size: 18px;"></i></a>
                                <? } ?>
