     ...
     <div class="box-body">
      ...
      <div class="col-xs-12">
       <div class="form-group">
        ...
        <?= $this->Form->input('description', ['value' => $row->description, 'class' => "form-control ckeditor", 'label' => false, 'kl_virtual_keyboard_secure_input' => "on", 'data-error' => 'Enter page description']); ?>
        <!--<div class="help-block with-errors"></div>-->
       </div>
      </div>
