              ...
              <div class="col-md-12">
               ...
               <div class="col-md-9">
                <div class="form-group">
                 ...
                 <?= $this->Form->input('value', ['type' => 'textarea', 'class' => "form-control ckeditor", 'label' => false, 'autocomplete' => 'off', 'kl_virtual_keyboard_secure_input' => "on", 'required' => "required", 'data-error' => 'Please enter link', 'value' => $row->value]); ?>
                 <div class="help-block with-errors"></div>
                </div>
               </div>
              </div>
