...
<!--                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <label for="exampleInputName">Transparent level </label>
                                <div class="slidecontainer">
  <input type="range" name='transparnt' min="1" max="10" value="<?=@$list->transparnt;?>" class="slider" id="myRange" style="display:block !important;">
  <p>Value: <span id="demo"></span></p>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="exampleInputName">Water mark image </label>
                                    <?php echo $this->Form->input('water_mark_image', array('type' => 'file', 'label' => false)); ?> 
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <img src="<?php echo HTTP_ROOT.WATERMARK; ?>result.png"/>
