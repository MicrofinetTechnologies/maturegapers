...
<!--                                <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    <label for="inputName">Release Date <span style="color:#FF0000">*</span></label>
                                        ...
                                        <input class="form-control release_date"  required="required" data-error = 'Enter scene video release date' id="release_date" name="releasedate" type="text"  autocomplete="off" value="<?=!empty(@$editData->releasedate) ?@date('Y-m-d',strtotime(@$editData->releasedate)) : date('Y-m-d');?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
