                            ...
                            <?php foreach ($dataListings as $list): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; width: 20%">
                                        <?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-edit')), ['action' => 'scenemain_video', $id, $list->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Edit", 'class' => 'btn btn-info hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
...
function setUrl(id){
    ...
    window.location.href='<?php echo HTTP_ROOT.'appadmins/scenemain_video/' ?>'+id;
}
</script>
<script>
