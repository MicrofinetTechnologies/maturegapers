...
<!--                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">                                      
                                        <textarea id="tags" name="tags" class="form-control" data-error = 'Enter video tags' placeholder="Ex:- Old and Young, Reality, Shaved, Bit, Tits"><?php echo @$editData->tags; ?></textarea>                                        
                                    </div>
                                ...
                                <?php if (isset($video_id) && !empty($video_id)) { ?>
                                    <div class="form-group">
                                        ...
                                        <video width="300" control>
                                            <source src="<?php echo HTTP_ROOT. VIDEOS.@$editData->scene_id.'/'.@$editData->video_file?>" type="video/mp4">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control release_date"  required="required" data-error = 'Enter scene video release date' id="release_date" name="release_date" type="text"  autocomplete="off" value="<?=@$editData->release_date;?>">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" name='__submit__' id='event_save' value="2" class="btn btn-danger">Save</button>  
                            ...
                            <?php foreach ($dataListings as $list): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center; width: 20%">
                                        <?php  echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-edit')), ['action' => 'scenebonus_video', $id, $list->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Edit", 'class' => 'btn btn-info hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
...
function setUrl(id){
    ...
    window.location.href='<?php echo HTTP_ROOT.'appadmins/scenebonus_video/' ?>'+id;
}
</script>
<script>
