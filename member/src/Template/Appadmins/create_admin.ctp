<div class="content-wrapper">
 <section class="content-header">
  ...
  <ol class="breadcrumb">
   ...
   <li class="active"><a  href="<?= h(HTTP_ROOT) ?>appadmins/view_admin"> <i class="fa fa-list"></i>Users List</a></li>
  </ol>
 </section>
 <!-- Main content -->
    ...
    <div class="box box-primary">
     ...
     <div class="box-footer">
      ...
      <?php
        ...
        if ($id) {
         echo $this->Form->button('Update Users', ['class' => 'btn btn-primary', 'style' => 'float:left;margin-left:15px;']);
        } else {
         echo $this->Form->button('Create Users', ['class' => 'btn btn-primary', 'style' => 'float:left;margin-left:15px;']);
        }
