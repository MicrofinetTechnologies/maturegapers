...
<link rel="stylesheet" href="<?= $this->Url->css('gallery.css'); ?>" type="text/css">
<script  src="<?= $this->Url->script('gallery.js'); ?>"></script>
<script src="<?php echo HTTP_ROOT . 'frontend/' ?>js/masonry.min.js"></script>
<script>
    var time = undefined;
    ...
    <div class="contain-in signle-model">
        ...
        <div class="single-model-sence">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-md-12">
                    <main id="gallery">
                        <div id="images" class="msrItems">
                            <div id="images">
                                <?php foreach ($modelallphotos as $phot) { ?>
                                    <div class="figure msrItem"><img class="image" src="<?= HTTP_ROOT . PHOTOS . $phot->model_id . '/' . $gallery_name . '/' . $phot->files_name; ?>" data-img-alt="<?= HTTP_ROOT . PHOTOS . $phot->model_id . '/' . $gallery_name . '/' . $phot->files_name; ?>"/>
                                        <div class="body">+</div>
                                    </div>
                                <?php } ?>
                            </div>
