                ...
                <div class="row">	
                    <div class="col-sm-5 col-lg-5 col-md-5 video-left">
                        <div class="video">
                            ...
                            <video controls crossorigin playsinline preload=""   id="player">
                                <!-- Video files -->
                                <?php if (file_exists(REVIDEOS . $first_scenes['scene_id'] . '/720p_' . @$first_scenes['video_file'])) { ?>
                                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $first_scenes['scene_id'] . '/720p_' . @$first_scenes['video_file']; ?>" type="video/mp4" size="720">
                                <?php } ?>

                                <?php if (file_exists(REVIDEOS . $first_scenes['scene_id'] . '/360p_' . @$first_scenes['video_file'])) { ?>
                                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $first_scenes['scene_id'] . '/360p_' . @$first_scenes['video_file']; ?>" type="video/mp4" size="360">
                                <?php } ?>

                                <?php if (file_exists(REVIDEOS . $first_scenes['scene_id'] . '/1080p_' . @$first_scenes['video_file'])) { ?>
                                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $first_scenes['scene_id'] . '/1080p_' . @$first_scenes['video_file']; ?>" type="video/mp4" size="1080">
                                <?php } ?>


                                <?php if (file_exists(REVIDEOS . $first_scenes['scene_id'] . '/4K_' . @$first_scenes['video_file'])) { ?>
                                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $first_scenes['scene_id'] . '/4K_' . @$first_scenes['video_file']; ?>" type="video/mp4" size="2160">
                                <?php } ?>

                                <?php if (!file_exists(REVIDEOS . $first_scenes['scene_id'] . '/4K_' . @$first_scenes['video_file']) && !file_exists(REVIDEOS . $first_scenes['scene_id'] . '/1080p_' . @$first_scenes['video_file']) && !file_exists(REVIDEOS . $first_scenes['scene_id'] . '/360p_' . @$first_scenes['video_file']) && !file_exists(REVIDEOS . $first_scenes['scene_id'] . '/720p_' . @$first_scenes['video_file'])) { ?>
                                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $first_scenes['scene_id'] . '/' . @$first_scenes['video_file']; ?>" type="video/mp4" size="480">
                                <?php } ?>
                    ...
                    <div class="col-sm-7 col-lg-7 col-md-7 video-right">
                        <ul>
                            ...
                            foreach ($scenes4photo as $valkey) {
                                ?>
                                <li><a href="<?php echo HTTP_ROOT . 'scence-single?scene-name=' . $first_scenes['scene_name'] . '-' . $first_scenes['scene_id']; ?>"><img src="<?php echo HTTP_REMOTE . PHOTOS . $valkey->photo_name; ?>" alt=""></a></li> 
...
<?php } ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12 col-md-12">
                        <div class="logo-contain">
                            <a href="<?= HTTP_ROOT . 'joinus'; ?>"><img src="<?php echo HTTP_REMOTE . SOCIAL_ICON . '/' . $siteDetails->logo; ?>" alt="logo"></a>
            ...
            <!--                                        <a href="<?php //echo HTTP_ROOT . 'users/setBannerCookie/' . $sceneslist->id . '/second-vsection1'    ?>"><img src="<?php //echo HTTP_ROOT . PHOTOS . $this->User->scenesngphoto($sceneslist->id)->photo_name;    ?>" class="img-responsive"></a>-->
                                        <img src="<?php echo HTTP_REMOTE . PHOTOS . $this->User->scenesngphoto($sceneslist->id)->photo_name; ?>" class="img-responsive" onclick="getsceneid(<?= $sceneslist->id; ?>)">
