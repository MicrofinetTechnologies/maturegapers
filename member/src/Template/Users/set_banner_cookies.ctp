...
<div class="row">	
    <div class="col-sm-5 col-lg-5 col-md-5 video-left">
        <div class="video">
            ...
            <video controls crossorigin playsinline preload=""   id="player1">
                <!-- Video files -->
                <?php if (file_exists(REVIDEOS . $last_scenes['scene_id'] . '/720p_' . $last_scenes['video_file'])) { ?>
                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $last_scenes['scene_id'] . '/720p_' . $last_scenes['video_file']; ?>" type="video/mp4" size="720">
                <?php } ?>

                <?php if (file_exists(REVIDEOS . $last_scenes['scene_id'] . '/360p_' . $last_scenes['video_file'])) { ?>
                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $last_scenes['scene_id'] . '/360p_' . $last_scenes['video_file']; ?>" type="video/mp4" size="360">
                <?php } ?>                                

                <?php if (file_exists(REVIDEOS . $last_scenes['scene_id'] . '/1080p_' . $last_scenes['video_file'])) { ?>
                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $last_scenes['scene_id'] . '/1080p_' . $last_scenes['video_file']; ?>" type="video/mp4" size="1080">
                <?php } ?>

                <?php if (file_exists(REVIDEOS . $last_scenes['scene_id'] . '/4K_' . $last_scenes['video_file'])) { ?>
                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $last_scenes['scene_id'] . '/4K_' . $last_scenes['video_file']; ?>" type="video/mp4" size="2160">
                <?php } ?>

                <?php if (!file_exists(REVIDEOS . $last_scenes['scene_id'] . '/720p_' . $last_scenes['video_file']) && !file_exists(REVIDEOS . $last_scenes['scene_id'] . '/360p_' . $last_scenes['video_file']) && !file_exists(REVIDEOS . $last_scenes['scene_id'] . '/1080p_' . $last_scenes['video_file']) && !file_exists(REVIDEOS . $last_scenes['scene_id'] . '/4K_' . $last_scenes['video_file'])) { ?>
                    <source src="<?php echo HTTP_REMOTE . VIDEOS . $last_scenes['scene_id'] . '/' . $last_scenes['video_file']; ?>" type="video/mp4" size="480">
<?php } ?>
            </video>
        </div>
    ...
    <div class="col-sm-7 col-lg-7 col-md-7 video-right">
        <ul>
            ...
            foreach ($scenes4photo as $valkey) {
                ?>
                <li><a href="<?php echo HTTP_ROOT . 'scence-single?scene-name=' . $last_scenes['scene_name'] . '-' . $last_scenes['scene_id']; ?>"><img src="<?php echo HTTP_REMOTE . PHOTOS . $valkey->photo_name; ?>" alt=""></a></li> 
