...
<div class="contain-section Searh-section">
    <div class="container">
                        ...
                        <div class="row">
                            <?php foreach ($models as $vals) {
                                ...
                                <div class="col-sm-3 col-lg-3 col-md-3">
                                    <div class="star-box">
                                        <img src="<?= HTTP_REMOTE . PHOTOS . $vals->cover_pic; ?>" alt="">
                                        <a href="<?= HTTP_ROOT . 'model-single?name=' . $vals->model_name . '-' . $vals->id; ?>"><?= $vals->model_name; ?></a>
                                    </div>
                                </div>
                            <?php } ?>
        ...
        <?php } ?>
                                                ...
                                                <a class="img-a" href="<?= HTTP_ROOT . 'scence-single?scene-name=' . $val->scene_name . '-' . $val->id; ?>"><img src="<?= HTTP_REMOTE . PHOTOS . $aimg; ?>" alt=""> </a>
                                            </div>

                                            <h4><a href="<?= HTTP_ROOT . 'scence-single?scene-name=' . $val->scene_name . '-' . $val->id; ?>"><?= $val->scene_name; ?></a></h4>
                                            <!-- <h5><a href="<?= HTTP_ROOT . 'model-single?name=' . $this->User->modelHelper($val->model1)->model_name . '-' . $val->model1; ?>"> <?= $this->User->modelHelper($val->model1)->model_name; ?> </a></h5>
