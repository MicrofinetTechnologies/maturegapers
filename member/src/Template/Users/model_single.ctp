                                                ...
                                                <div class="col-sm-3 col-lg-3 col-md-3">
                                                    <ul>
                                                        ...
                                                        foreach ($modelphotos1 as $photo) {
                                                            ...
                                                            if ($cxt <= 4) {
                                                                ?>
                                                                <li  style="transform: rotate(<?= $deg -= 12; ?>deg);max-height:120px;"><img src="<?= HTTP_REMOTE . PHOTOS . $modeldetails->id . '/' . $gallery->name . '/' . $photo->files_name; ?>"></li>
                                                            <?php }
                                                        } ?>
                                                    </ul>
                                                </div>					
...
<div class="container">
    <div class="contain-in signle-model">
        ...
        <div class="single-model-sence">
            <div class="row">
                <div class="col-sm-12 col-lg-12 col-md-12">
<!--					<h2>All scenes with <?= $modeldetails->model_name; ?><a href="<?= HTTP_ROOT . 'model-photos/' . $modeldetails->id; ?>">Model Photo Gallery</a></h2>-->
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="sence-box">
                            <div class="single-scence-img">
                                <a href="<?= HTTP_ROOT . 'scence-single/?scene-name=' . $scnval->scene_name . '-' . $scnval->id; ?>"><img src="<?= HTTP_REMOTE . PHOTOS . $this->User->scenesngphoto($scnval->id)->photo_name; ?>" alt=""></a>
                            </div>
