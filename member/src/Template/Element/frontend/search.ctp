...
<section class="search_event">
 <link type="text/css" rel="stylesheet" href="<?php echo HTTP_REMOTE . 'css/frontend' ?>/search-calender-style.css"/>
 <script type="text/javascript" language="javascript" src="<?php echo HTTP_REMOTE . 'admin-assets/js' ?>/search-simplecalendar.js"></script>
