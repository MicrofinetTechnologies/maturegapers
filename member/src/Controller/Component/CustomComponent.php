  ...
  class CustomComponent extends Component
   ...
   function simpleImageUpload($temp_name,$name,$path){
    ...
    public static function GenerateThumbnail($im_filename,$th_filename,$max_width,$max_height,$quality = 0.75){
        $watermark_png_file =  HTTP_ROOT.'img/watermark.png'; 
   ...
   function sendEmail($to, $from, $subject, $message, $header = 1, $footer = 1) {
    ...
    <td width="150" style="font:12px Helvetica,sans-serif;color:#7b7b7b">EMAIL:<a target="_blank" style="text-decoration:none" href="mailto:contact@encore.com"><font color="#c93239"> contact@encore.com </font></a></td>
